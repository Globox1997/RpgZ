...
public class LivingEntityScreenHandler9x3 extends AbstractContainerMenu {
   private final SimpleContainer inventory;

   public LivingEntityScreenHandler9x3(int syncId, Inventory playerInventory) {
      this(syncId, playerInventory, new SimpleContainer());
   }

   public LivingEntityScreenHandler9x3(int syncId, Inventory playerInventory, SimpleContainer simpleInventory) {
